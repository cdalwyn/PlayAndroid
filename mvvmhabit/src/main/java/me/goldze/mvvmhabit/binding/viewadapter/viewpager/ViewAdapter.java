...
public class ViewAdapter {
    ...
    public static void onScrollChangeCommand(final ViewGroup viewGroup,
        ...
        if (viewGroup instanceof ViewPager2) {
            ((ViewPager2) viewGroup).registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
                @Override
        ...
        if (viewGroup instanceof ViewPager) {
            ((ViewPager) viewGroup).addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                private int state;
